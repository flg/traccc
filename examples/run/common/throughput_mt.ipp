...
int throughput_mt(std::string_view description, int argc, char* argv[]) {
    ...
    seedfinder_config.deltaRMin = 28 * unit<float>::mm;
    seedfinder_config.deltaRMax = 162 * unit<float>::mm;

    seedfinder_config.minPt = 400.f * unit<float>::MeV;
    seedfinder_config.cotThetaMax = 27.2899f;
    seedfinder_config.impactMax = 10.f * unit<float>::mm;
    ...
    finding_cfg.max_num_branches_per_surface = 5;
